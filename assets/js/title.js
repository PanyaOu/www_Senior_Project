...
(function initThree() {
    ...
    Promise.all([
        webgl.texture,    
        webgl.loader.load('../assets/images/word-cloud-2.jpg'),                           
    ...
    webgl.texturesOptions = [
        ...
        { index: 1, texture: "image", threshold: 20, random: 0.0, depth: 0.0, size: 2, square: 0 }
        // { index: 2, texture: "image", threshold: 100, random: 1.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 3, texture: "image", threshold: 10, random: 1.0, depth: 2.0, size: 1.2, square: 0},
        // { index: 4, texture: "video", threshold: 100, random: 2.0, depth: 2.0, maxDepth: 60, size: 1.5, square: 0 },
        // { index: 5, texture: "image", threshold: 80, random: 1.0, depth: 4.0, maxDepth:120, size: 1.5, square: 0 },
        // { index: 6, texture: "image", threshold: 30, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 7, texture: "image", threshold: 30, random: 2.0, depth: 3.0, size: 1.0, square: 1 },
        // { index: 8, texture: "image", threshold: 60, random: 0.8, depth: 4.0, size: 0.6, square: 1 },
        // { index: 9, texture: "image", threshold: 20, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 10, texture: "image", threshold: 20, random: 2.0, depth: 8.0, size: 1.5, square: 0, a2: true },
        // { index: 11, texture: "image", threshold: 30, random: 2.0, depth: 30.0, maxDepth: 100, size: 1.5, square: 0, a3: true, a4: true, stagger: 0.3 },  //72
        // { index: 12, texture: "image", threshold: 60, random: 2.0, depth: 2.0, maxDepth: 80, size: 1.5, square: 0, color: "transparent", stagger: 1 },
        // { index: 13, texture: "image", threshold: 60, random: 2.0, depth: 4.0, maxDepth: 60, size: 1.5, square: 0 },
        // { index: 14, texture: "video", threshold: 60, random: 2.0, depth: 15.0, maxDepth: 120, size: 2.0, square: 0, stagger: 1 },
        // { index: 15, texture: "image", threshold: 20, random: 2.0, depth: 4.0, maxDepth:180, size: 1.5, square: 0 },
        // { index: 16, texture: "image", threshold: 0, random: 2.0, depth: 3.0, maxDepth: 100, size: 1.5, square: 0, a5: true },
        // { index: 17, texture: "video", threshold: 100, random: 4.0, depth: 20.0, maxDepth: 100, size: 1.5, square: 0, a4: true },
        // { index: 18, texture: "image", threshold: 60, random: 2.0, depth: 40.0, maxDepth: -100, size: 1.5, square: 0, a6: true },
        // { index: 19, texture: "video", threshold: 30, random: 2.0, depth: 20.0, maxDepth: 80, size: 1.5, square: 0 },
        // { index: 20, texture: "video", threshold: 30, random: 2.0, depth: 30.0, maxDepth: 100, size: 1.5, square: 0, a8:true },
        // { index: 21, texture: "video", threshold: 100, random: 2.0, depth: 10.0, size: 1.5, square: 0 },
        // { index: 22, texture: "image", threshold: 30, random: 1.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 23, texture: "video", threshold: 30, random: 2.0, depth: 30.0, maxDepth: -50, size: 1.5, square: 0 },
        // { index: 24, texture: "image", threshold: 30, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 25, texture: "image", quote: '“I <span style="color:#ea1f66"> always</span> take two!”', threshold: 10, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        // { index: 26, texture: "image", threshold: 20, random: 2.0, depth: 4.0, size: 1.5, square: 0, a1: true },
        // { index: 27, texture: "image", threshold: 20, random: 2.0, depth: 4.0, maxDepth:150, size: 1.5, square: 0, a10:true },
        // { index: 28, texture: "video", threshold: 30, random: 2.0, depth: 15.0, maxDepth: 50, size: 1.5, square: 0, a6:true },
        // { index: 29, texture: "video", threshold: 60, random: 2.0, depth: 18.0, size: 1.5, square: 0, a9:true },
        // { index: 30, texture: "video", threshold: 150, random: 2.0, depth: 20.0, maxDepth: 70, bg: '#000', size: 1.5, square: 0 },
        // { index: 31, texture: "image", threshold: 60, random: 2.0, depth: 4.0, size: 1.5, square: 0, a4:true, a1:true },
        // { index: 32, texture: "video", threshold: 100, random: 2.0, depth: 10.0, maxDepth: 60, size: 1.5, square: 0, a1: true },
        // { index: 33, texture: "video", threshold: 160, random: 2.0, depth: 3.0, size: 1.5, square: 0 },
        // { index: 34, texture: "video", threshold: 60, random: 2.0, depth: 5.0, maxDepth: 40.0, size: 1.5, square: 0 },
    ];
})();
